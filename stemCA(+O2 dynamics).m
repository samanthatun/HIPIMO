...
%% cell behaviour
pSTEM_SymmDiv = 0.9; %probability of SYMMETRIC division of STEM CELLS
pSTEM_AsymmDiv = 0.1; %probability of ASYMMETRIC division STEM to TAC transition

pTAC_SymmDiv = 1; %probability of SYMMETRIC division of TAC CELLS
pTAC_Dediff = 0; %probability of TAC to STEM transition
